...
const sanitarywareProducts = [
  ...
  // WB- products (Wall-mounted Basins) → category: "basins", subcategory: "wall-mounted basin"
  {
    ...
    name: "WB-017C",
    category: "basins",
    subcategory: "wall-mounted basin",
    image: "/WB-017C.png",
    suggestions: [
      "Elegant design with timeless appeal.",
      "Smooth surface for easy cleaning and maintenance.",
...
const tilesProducts = [
  ...
  },
  {
    ...
    name: "MR 36015k",
    category: "floor",
    subcategory: "micassofloor",
    image: "/images/micasso1.jpg",
    suggestions: [
      "Ideal for stores, bathrooms, and bedrooms.",
      "Matte finish provides a natural and elegant look.",
      "Part of the Enchanted Forest series, blending nature-inspired aesthetics with durability.",
    ],
  },
  {
    id: 172,
    ...
    category: "floor",
    subcategory: "micassofloor",
    image: "/images/micasso2.jpg",
    suggestions: [
      "Perfect for bathrooms, bedrooms, and stores.",
      "Grey matte finish adds a sleek, modern touch.",
      "Belongs to the Enchanted Forest series, ideal for a warm and natural ambiance.",
    ],
  },
  {
    id: 173,
    name: "MCP 36011k",
    category: "wall",
    subcategory: "micassowall",
    image: "/images/micasso3.jpg",
    suggestions: [
      "Glossy finish enhances brightness in a space.",
      "Sized at 300x600mm, ideal for walls.",
      "Reflective surface adds a touch of luxury to bathrooms and kitchens.",
    ],
  },
  {
    id: 174,
    ...
    category: "floor",
    subcategory: "micassofloor",
    image: "/images/micasso4.jpg",
    suggestions: [
      "Best for matching or border applications.",
      "Black matte finish creates a bold and luxurious feel.",
      "Part of the Rome Marble & Stone series, offering a timeless and sophisticated touch.",
    ],
  },
  {
    id: 175,
    ...
    category: "floor",
    subcategory: "micassofloor",
    image: "/images/micasso5.jpg",
    suggestions: [
      "Versatile for bathrooms, stores, and bedrooms.",
      "Matte grey finish complements neutral palettes.",
      "From the Rome Marble & Stone collection, designed for a refined and classic look.",
    ],
  },
  {
    id: 176,
    ...
    category: "wall",
    subcategory: "micassowall",
    image: "/images/micasso6.jpg",
    suggestions: [
      "Classic white glossy finish for a timeless appeal.",
      "300x600mm size, perfect for walls.",
      "Enhances natural light reflection, making small spaces appear larger.",
    ],
  },
  {
    id: 177,
    ...
    category: "floor",
    subcategory: "micassofloor",
    image: "/images/micasso7.jpg",
    suggestions: [
      "Elegant brown-toned tile for warm interiors.",
      "Works well for both residential and commercial spaces.",
      "Matte finish provides a soft, natural look with subtle texture.",
    ],
  },
  {
    id: 178,
  ...
  },
  {
    ...
    category: "wall",
    subcategory: "micassowall",
    image: "/images/micasso8.jpg",
    suggestions: [
      "Glacier white tile with a glossy surface.",
      "Sized at 300x600mm, ideal for contemporary walls.",
      "Reflects light beautifully, creating a spacious and bright environment.",
    ],
  },
  {
    id: 184,
    ...
    category: "floor",
    subcategory: "micassofloor",
    image: "/images/micasso9.jpg",
    suggestions: [
      "Rich brown tones for a warm, inviting space.",
      "Pairs well with neutral and earthy palettes.",
      "Matte finish enhances texture and depth, making it a stylish choice.",
    ],
  },
  {
    id: 185,
    ...
    category: "wall",
    subcategory: "micassowall",
    image: "/images/micasso10.jpg",
    suggestions: [
      "Grey inkjet glazed tile with a smooth, glossy finish.",
      "Comes in 8pcs per box, great for wall installations.",
